...
const HeaderLeft = () => {
  return (
    <div className="md:flex-[1]">
      <div className="min-h-screen top-0 hidden md:sticky md:flex items-center justify-center bg-teal-900 text-white">
      ...
      <div className="fixed left-0 right-0 top-0 z-10 flex justify-evenly bg-teal-900 p-5 text-white md:hidden">
